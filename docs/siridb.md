...
```text
[number of metrics] [length of name and tags] [name and tags] [length of field key1] [length of timestamp1 and field value1] [field key1] [packed timestamp1 and value1] [length of field key2] [length of timestamp2 and field value2] [field key2] [packed timestamp2 and value2]... etc.
